...
export const Favorites = () => {
	return (
		<>
			...
			<div className="Profile d-flex pt-3 col-xl-12 border-top border-dark">
				<div className="mr-auto p-2 col-xl-4 pb-5 pl-5 pt-2">
					<h2 id="Profile-section">Profile: Name</h2>
					<a type="button" href="/about-us" className="btn btn-primary">Profile Settings</a>
				</div>
				<div className="p-2 align-self-cent0er col-xl-8">
